...
async def pdisk_uploader(bot, message):
    ...
    conv = await message.reply("Converting your link to linkshortify...")
...
async def remove_username(new_List):
    for i in new_List:
        if('@' in i or 't.me' in i or 'https://bit.ly/abcd' in i or 'https://bit.ly/123abcd' in i or 'telegra.ph' in i or 'Join' in i or 'channel' in i or '🚀 Here is your Link:' in i):
            new_List.remove(i)
    return new_List
