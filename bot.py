...
async def pdisk_up(link):
    if ('mega' in link or 'google' in link or 'mdisk' in link or 'entertainvideo' in link or 'dood' in link or 'bit' in link or 'mediafire' in link or 'shadowave' in link or 'dashboard' in link ):
